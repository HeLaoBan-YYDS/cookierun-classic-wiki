    ...
    <div className="space-y-16">
      ...
      <section className="text-center">
        ...
        <div className="mt-7 flex flex-wrap justify-center gap-3">
          <Button asChild size="lg"><Link href={localizeHref(BEGINNER_GUIDE_HREF, locale)}>{home.hero.primaryCta}<ArrowRight className="ml-2 h-4 w-4" /></Link></Button>
          <Button asChild size="lg" variant="outline"><Link href={localizeHref(COMBO_GUIDE_HREF, locale)}>{home.hero.secondaryCta}</Link></Button>
          <Button asChild size="lg" variant="ghost"><Link href={localizeHref(CODES_HREF, locale)}>{home.hero.tertiaryCta}</Link></Button>
        </div>
      </section>
